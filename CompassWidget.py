#Retrived from https://wiki.python.org/moin/PyQt/Compass%20widget
import sys
...
class CompassWidget(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self._pointText = {0: "N", 45: "NE", 90: "E", 135: "SE", 180: "S",
                           225: "SW", 270: "W", 315: "NW"}
        logging.info("CompassWidget: Initialized Compass")
    ...
    def setAngle(self, angle):
        if angle != self._angle:
            ...
            self.update()
            logging.info("CompassWidget: Compass angle changed to %f"%(angle))
