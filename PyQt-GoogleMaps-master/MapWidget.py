__author__ = 'Kyle'
# Retrived from https://github.com/kylekirkby/PyQt-GoogleMaps on Sept. 10, 2018
...
<html>
  <head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDUzgY2d1vywaH-FVkrdWnRvUXpKQyfHcE" type="text/javascript"></script>
    <script>
